  ...
  <div style={{ flex: 1 }} className='mt-5'>
    <Container>
      <Row className="justify-content-center mt-5"> 
        <Col lg={8} md={10} sm={12} className='p-4 border'>
          ...
          <div className="d-flex justify-content-between mt-5">
            <Button style={{width: '33%'}} variant="primary" onClick={() => handleAnswer('yes')}>Da</Button>
            <Button style={{width: '33%'}}  variant="secondary" onClick={() => handleAnswer('no')}>Nu</Button>
          </div>
        </Col>
      </Row>
    </Container>
